...
public class NorGateLogic : MonoBehaviour, ILogicValue
{
    ...
    public bool GetValue()
    {
        ...
        bool a = HasValidConnection(inputA) ? GetConnectedValue(inputA) : false;
        bool b = HasValidConnection(inputB) ? GetConnectedValue(inputB) : false;

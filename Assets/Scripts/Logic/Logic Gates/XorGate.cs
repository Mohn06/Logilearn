...
public class XorGate : MonoBehaviour, ILogicInteract
{
    [Header("Gate Visuals")]
    public Sprite Zero;
    public Sprite One;
    ...
    public void SetInput(bool value, int inputIndex)
    {
        switch (inputIndex)
        {
            ...
            case 1:
                ...
                break;
            default:
                Debug.LogWarning("[XOR] Invalid input index");
                return;
        }
    ...
    void Evaluate()
    {
        ...
        // XOR logic: true only if inputs are different
    ...
    void SetOutput(bool value)
    {
        ...
        Debug.Log($"[XOR] A={(inputA ? 1 : 0)} B={(inputB ? 1 : 0)} → Output={(Output ? 1 : 0)}");
    }
